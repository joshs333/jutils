 ...
 * @brief implementation of jutils::array (a 1d interopable array data-structure) and some helpers.
 * @date 2022-05-07
 */
#ifndef JUTILS_ARRAY_HPP_
#define JUTILS_ARRAY_HPP_
