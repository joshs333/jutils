 ...
 * @brief implementation of jutils::multi_array (a 2d interopable array data-structure) and some helpers.
 * @date 2022-05-07
 */
#ifndef JUTILS_MULTI_ARRAY_HPP_
#define JUTILS_MULTI_ARRAY_HPP_
