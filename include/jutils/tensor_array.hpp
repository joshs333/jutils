 ...
 * @brief implementation of jutils::tensor_array (a 3d interopable array data-structure) and some helpers.
 * @date 2022-05-07
 */
#ifndef JUTILS_TENSOR_ARRAY_HPP_
#define JUTILS_TENSOR_ARRAY_HPP_
...
#endif /* JUTILS_TENSOR_ARRAY_HPP_ */